	...
	<nav class="navbar">
		<div class="logo_item">
			<i class="bx bx-menu" id="sidebarOpen"></i> <img src="img/logo.png"
				alt=""></i>Colegio Alfonso Ugarte N°20191
		</div>
		...
		<div class="menu_content">
			<ul class="menu_items">
				...
				<!-- start -->
					...
					</span> <span class="navlink">Dashword</span>
				</a></li>
				<!-- end -->
...
<!-- 				</a></li> -->
				...
				<li class="item"><a href="worker.jsp" class="nav_link"> <span
						class="navlink_icon"> <i class="bx bx-loader-circle"></i>
					</span> <span class="navlink">Worker</span>
				</a></li>
			...
			<ul class="menu_items">
				...
				<li class="item">
					...
					<ul class="menu_items submenu">
						...
						<a href="paymentApafa.jsp" class="nav_link sublink">APAFA payments</a>
					</ul>
				</li>
				<!-- 				end -->
			...
			<div class="bottom_content">
				<div class="bottom expand_sidebar">
					<span> Expandir Menú</span> <i class='bx bx-log-in'></i>
				</div>
				<div class="bottom collapse_sidebar">
					<span> Ocultar Menú</span> <i class='bx bx-log-out'></i>
				</div>
			</div>
		</div>
	</nav>
